...
<div class="bg-black text-shadow">
                    ...
                    <div class="row no-margin">
                      ...
                      <%--      <h3 class="fg-white">Follow Me</h3>
                            ...
                            <a class="icon-skype on-right on-left" href ="skype:gopala.krishna_1" style=--%>"background: skyblue;color: white; padding: 10px; border-radius: 50%"></a>
                             ...
                             <h3 class="fg-white"> Like & Share</h3>
                        ...
                        <div class="span6 padding5">
                                    <%--<h4 class="fg-white">Contact me if you need professional advice on</h4>--%>
                         </div>
            ...
            <div class="container tertiary-text bg-black fg-white " style="padding: 0px " >
                <footer>
